...
const PostView = ({ postId }: PostViewProps) => {
  ...
  const handleHighlightClick = useCallback((commentId: number) => {
    ...
    // Add a temporary highlight effect to the clicked text
    const highlightedText = document.querySelector(`.selection-highlight[data-comment-id="${commentId}"]`);
    if (highlightedText) {
      highlightedText.classList.add('highlight-focus-pulse');
      setTimeout(() => {
        highlightedText.classList.remove('highlight-focus-pulse');
                        ...
                        return (
                          <div 
                            ...
                            onClick={() => {
                              ...
                              // Find and scroll to the highlighted text associated with this comment
                              const highlightedText = document.querySelector(`.selection-highlight[data-comment-id="${id}"]`);
                              if (highlightedText) {
                                // Scroll the main content to the highlighted text
